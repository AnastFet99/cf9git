...
2. Η εφαρμογή ελέγχει αν το έτος διαιρείται με το 400.  
   [Εναλλακτική ροή 2α: Το έτος δεν διαιρείται με το 400]  
   1. Η εφαρμογή εμφανίζει μήνυμα "Δεν είναι δίσεκτο"
   2. Η εφαρμογή τερματίζει
3. Η εφαρμογή ελέγχει αν το έτος διαιρείται με το 4 Ή αν το έτος διαιρείται με το 100.  
   [Εναλλακτική ροή 3α: Το έτος δεν διαιρείται με το 4 και διαιρείται με το 100]
   1. Η εφαρμογή εμφανίζει μήνυμα "Δεν είναι δίσεκτο"
   2. Η εφαρμογή τερματίζει
